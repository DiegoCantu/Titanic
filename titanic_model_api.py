...
db_uri = 'sqlite:///{}/titanic_datos.db'.format(os.path.dirname(__file__))
...
api = Api(
    app, 
    version='1.0', title='TITANIC REST',
    description='A very simple logistic regression model from https://www.kaggle.com/mashimo/a-very-simple-logistic-regression-model/notebook#1.-Collect-and-understand-the-data',
)
...
ns = api.namespace('survival', description='Predict survival on the Titanic')
...
# base de datos.
from db_titanic_models import Prediction
db.create_all()
...
survivalObservation = api.model('Survival', {
    'Pclass': fields.Integer(description="Clase del pasajero"),
    'Sex': fields.Integer(description="Sexo"),
    'Age': fields.Float(description="Edad"),
    'SibSp': fields.Integer(description=""),
    'Parch': fields.Integer(description=""),
    'Fare': fields.Float(description="Tarifa"),
    'Embarked_C': fields.Integer(description="Embarcación C"),
    'Embarked_Q': fields.Integer(description="Embarcación Q"),
    'Embarked_S': fields.Integer(description="Embarcación S"),
})


# =======================================================================================
predictive_model = pickle.load(open('titanic_model.pkl','rb'))
...
class PredictionListAPI(Resource):
    ...
    def post(self):
        ...
        model_data = [numpy.array([
            prediction.Pclass, prediction.Sex, 
            prediction.Age, prediction.SibSp, 
            prediction.Parch, prediction.Fare, 
            prediction.Embarked_C, prediction.Embarked_Q, 
            prediction.Embarked_S 
        ])]
